...
$_SESSION['user_id'] = 1;
$_SESSION['user_tz'] = 'Europe/Vienna';
...
if(isset($_SESSION['user_id'])){
    // If this is the forum.php page, add a link for posting new threads:
...
echo '<li class="dropdown"><a href="forum.php" class="dropdown-toggle" data-toggle="dropdown"
role="button" aria-haspopup="true" aria-expanded="false">' . $words['language'] . '<span class="caret"></span></a>
