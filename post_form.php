...
// Its included by other pages, never called directy

// Redirect if this page is called directy:
if (!isset($words)){
...
if (isset($_SESSION['user_id'])){
    ...
    if (isset($tid) && $tid) {
        ...
        echo '<div class="form-group"><label for="subject">' . $words['subject'] . '</label><input name="subject" type="text" class="form-control" size="6" maxlength="100"';
    ...
    // Finish the form:
    echo '<input name="submit" type="submit" class="form-control" value="' . $words['submit'] . '"></form>';
} else {
